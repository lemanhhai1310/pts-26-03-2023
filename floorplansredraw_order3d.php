<?php $data["title"] = "Floor plans redraw Order page 3D"; ?>
<?php $bodyClass = '' ?>
<?php $isLogin = false ?>
...
<div class="uk-section">
    <div class="uk-container uk-container-large">
        ...
        <div class="item__140-70 uk-grid-40-l uk-grid-small" uk-grid>
            ...
            <div class="uk-width-expand">
                ...
                <div class="item__40-20 floorplansredraw__label">Preferences</div>
                <div class="item__40-20 uk-child-width-1-2@m uk-child-width-1-3@l uk-grid-small uk-grid-40-l" uk-grid>
                    <div>
                        <div class="uk-form-stacked">
                            <label class="uk-form-label virtualrenovation__label" for="form-stacked-text">Story/level*</label>
                            <div class="uk-form-controls">
