    ...
    <div class="uk-width-expand">
        <div class="uk-container">
            <div class="sign_in__card uk-card uk-card-body uk-card-default uk-height-min-large">
                <div class="uk-text-center sign_in__card__title">Create a new account</div>
                ...
                <form class="uk-form-stacked item__40-20">
                    ...
                    <div class="uk-margin">
                        <label class="uk-form-label sign_in__card__label" for="form-stacked-name">Name</label>
                        <div class="uk-form-controls">
                            <input class="uk-input sign_in__card__input" id="form-stacked-name" type="email" placeholder="Enter name">
                        </div>
                    </div>
                    ...
                    <div class="item__40-20">
                        <label class="uk-form-label sign_in__card__label" for="form-stacked-tel">Phone number</label>
                        <div class="uk-form-controls">
                            <input class="uk-input sign_in__card__input" id="form-stacked-tel" type="tel" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="item__40-20">
                        <div class="" uk-grid>
                            <div class="uk-width-expand">
                                <label class="uk-form-label sign_in__card__label" for="form-stacked-select">Password</label>
                            </div>
                            <div class="uk-width-auto">
                                <a href="forgot_password.php" class="sign_in__card__link">Forgot password?</a>
                            </div>
                        </div>
                        <div class="uk-form-controls item__5">
                            <div class="uk-inline uk-width">
                                <a class="uk-form-icon uk-form-icon-flip" href="#" uk-icon="icon: eye"></a>
                                <input class="uk-input sign_in__card__input" type="password" placeholder="Enter password" aria-label="Clickable icon">
                            </div>
                        </div>
                    </div>

                    <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                        <label class="sign_in__card__txtCheck"><input class="uk-checkbox" type="checkbox" checked> Creating an account means you’re okay with our
                            <a href="">Terms of Service</a> and
                            <a href="">Privacy Policy</a>.</label>
                    </div>

                    <button type="button" class="sign_in__card__btn uk-button item__40-20 uk-button-primary uk-width uk-border-rounded">Create account</button>
