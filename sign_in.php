    ...
    <div class="uk-width-expand">
        <div class="uk-container">
            <div class="sign_in__card uk-card uk-card-body uk-card-default uk-height-min-large">
                <div class="uk-text-center sign_in__card__title">Sign in to your account</div>
                ...
                <form class="uk-form-stacked item__40-20">
                    ...
                    <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                        <label class="sign_in__card__txtCheck"><input class="uk-checkbox" type="checkbox" checked> Remember me</label>
                    </div>

                    <button type="button" class="sign_in__card__btn uk-button item__40-20 uk-button-primary uk-width uk-border-rounded">Sign in</button>
                    
                    <div class="uk-text-center item__40-20 sign_in__card__txt">Do not have an account? <a href="sign_up.php">Create an account</a></div>
                </form>
            </div>
        </div>
    </div>
