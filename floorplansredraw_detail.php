<?php $data["title"] = "Floor plans redraw detail"; ?>
<?php $bodyClass = '' ?>
<?php $isLogin = false ?>
...
<div class="uk-section">
    <div class="uk-container uk-container-large">
        <h1 class="uk-h1 uk-text-center single__title">Floor plans redraw</h1>
        ...
        <h2 class="uk-h2 uk-text-center item__40-20 virtualrenovation__title1">
            Floor Plan Redraws, US$24.00 to US$32.0024 Hour <br class="uk-visible@m"> Turnaround
        </h2>
        ...
        <div class="uk-grid-8-l item__80-40" uk-grid>
            <div class="uk-width-expand">
                <div class="home__sendPhoto__titleSmall">Benefits</div>
                <h1 class="uk-h1 uk-margin home__sendPhoto__title">Floor plans redraw</h1>
            ...
            <div class="uk-width-2-5@l">
                <div class="home__sendPhoto__box uk-card uk-card-default uk-padding-small sidebar">
                    <div class="home__sendPhoto__legend" style="">select order information</div>
                    ...
                    <div class="item__20 uk-form-stacked">
                        <label class="uk-form-label home__sendPhoto__labelTxt" style="" for="form-stacked-text">Kind of Template:</label>
                        <div class="uk-form-controls">
                            <div class="uk-child-width-1-2 uk-child-width-1-3@m uk-grid-20-m uk-grid-small" uk-grid>
                                <?php for ($i=1;$i<=6;$i++): ?>
                                    <label>
                                        ...
                                        <div class="home__sendPhoto__boxRadio">
                                            ...
                                            <div class="home__sendPhoto__boxRadio__txt item__8 uk-flex uk-flex-center uk-flex-middle" style="font-size: 16px !important;">
                                                2D full colour
                    ...
                    <div class="item__40-20 uk-form-stacked">
                        <label class="uk-form-label home__sendPhoto__labelTxt" for="form-stacked-text" style="">Delivery time:</label>
                        <div class="uk-form-controls">
