<?php $data["title"] = "Singlephoto detail"; ?>
<?php $bodyClass = '' ?>
...
<div class="uk-section">
    <div class="uk-container uk-container-large">
        <h1 class="uk-h1 uk-text-center single__title">Single Photo</h1>
        ...
        <div class="uk-grid-8-l item__40-20" uk-grid>
            ...
            <div class="uk-width-2-5@l">
                <div class="home__sendPhoto__box uk-card uk-card-default uk-padding-small">
                    ...
                    <div class="uk-margin single__card__txtSmall">(The options below are at no extra cost, you can choose not to)</div>
                    <div class="item__20 uk-grid-small uk-child-width-1-2 uk-grid" uk-grid>
                        <?php
                    ...
                    <div class="item__40-20 uk-form-stacked">
                        ...
                        <div class="uk-form-controls">
                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid" uk-grid>
                                <label class="single__card__radioLabel"><input class="uk-radio" type="radio" name="radio3" checked> Delivery time 18 hours (Default)</label>
                                <label class="single__card__radioLabel"><input class="uk-radio" type="radio" name="radio3"> Delivery time 12 hours ($5)</label>
                            </div>
                        </div>
                    </div>

                    <div class="item__40-20 single__card__boxTotal">
                        <div class="" uk-grid>
                            <div class="uk-width-expand">
                                <div class="single__card__boxTotal__txt">Total:</div>
                            </div>
                            <div class="uk-width-auto">
                                <div class="single__card__boxTotal__price">$10</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <button class="home__sendPhoto__btn home__sendPhoto__btn--primary uk-button uk-button-primary uk-width item__20">
                        Send now
