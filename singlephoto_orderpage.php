<?php $data["title"] = "Singlephoto Order page"; ?>
<?php $bodyClass = '' ?>
<?php require "template-parts/layouts/header.php"; ?>
<div class="uk-section order__content">
    <div class="uk-container uk-container-large">
        <div class="uk-grid-8-l" uk-grid>
            <div class="uk-width-expand">
                <div class="home__sendPhoto__titleSmall">Send photos</div>
            ...
            <div class="uk-width-2-5@l">
                <div class="home__sendPhoto__box uk-card uk-card-default uk-padding-small sidebar">
                    ...
                    <div class="item__80-40 single__card__boxTotal">
                        <div class="" uk-grid>
                            <div class="uk-width-expand">
